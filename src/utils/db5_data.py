...
from src.utils.protein_utils import preprocess_dips_unbound_bound, preprocess_db5_unbound_bound, preprocess_unbound_bound, protein_to_graph_unbound_bound, UniformRotation_Translation
import pickle
    ...
    def __init__(self, args, if_swap=True, reload_mode='train',
        ...
        if load_from_cache:
            ...
            if args['data'] == 'db5':
                ...
                preprocess_result = pmap_multi(preprocess_db5_unbound_bound,
                                            code_list,
                                            n_jobs=args['n_jobs'],
                ...
                assert args['data'] == 'dips'
                print('Start preprocess_unbound_bound')
                ## Concat the function get_residues and preprocess_unbound_bound into single function preprocess_dips_unbound_bound to save RAM
                preprocess_result = pmap_multi(preprocess_dips_unbound_bound,
                                            dill_filenames_list,
                                            n_jobs=args['n_jobs'],
                                            raw_data_path=raw_data_path,
                                            graph_nodes=args['graph_nodes'],
            ...
            with open("protein_to_graph_input_1.pkl", 'wb') as outfile:
                pickle.dump(protein_to_graph_input, outfile, pickle.HIGHEST_PROTOCOL)
